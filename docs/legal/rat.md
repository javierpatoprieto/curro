...
| **Medidas de seguridad (Art. 30.1.g)** | Carga de GA4 **condicionada al consentimiento** (banner de cookies); **anonimización de IP** y ajustes de retención en la configuración de GA4; transporte cifrado (HTTPS). Los datos los trata **Google como encargado** bajo sus *Data Processing Terms* (Google Ads/Analytics), que incorporan las medidas de seguridad de Google. Gestión y revocación de cookies desde el banner. |
